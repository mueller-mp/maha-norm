...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if in_planes != planes:
            ...
            self.downsample.add_module('conv', conv1x1(in_planes, planes, stride=stride, bias=norm is None))
            self.downsample.add_module('norm', nn.Identity() if norm is None else norm(num_features=planes))
...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        if stride != 1 or in_planes != planes * self.expansion:
            self.downsample = nn.Sequential()
            self.downsample.add_module('conv',conv1x1(in_planes, planes * self.expansion, stride=stride, bias=norm is None))
            self.downsample.add_module('norm', nn.Identity() if norm is None else norm(num_features=planes * self.expansion))
...
def resnet20_nosequential(num_classes: int = 10,
             in_channels: int = 3
             ) -> ResNet:
    """ ResNet by He+16
    """
...
def resnet32_nosequential(num_classes: int = 10,
             in_channels: int = 3
             ) -> ResNet:
    """ ResNet by He+16
    """
...
def resnet56_nosequential(num_classes: int = 10,
             in_channels: int = 3
             ) -> ResNet:
    """ ResNet by He+16
    """
...
def resnet110_nosequential(num_classes: int = 10,
              in_channels: int = 3
              ) -> ResNet:
    """ ResNet by He+16
    """
...
def se_resnet20_nosequential(num_classes: int = 10,
                in_channels: int = 3
                ) -> ResNet:
    """ SEResNet by Hu+18
    """
...
def se_resnet56_nosequential(num_classes: int = 10,
                in_channels: int = 3
                ) -> ResNet:
    """ SEResNet by Hu+18
    """
...
def wrn16_8_nosequential(num_classes: int = 10,
            in_channels: int = 3
            ) -> ResNet:
...
def wrn28_2_nosequential(num_classes: int = 10,
            in_channels: int = 3
            ) -> ResNet:
    """ WideResNet by Zagoruyko&Komodakis 17
    """
...
def wrn28_10_nosequential(num_classes: int = 10,
             in_channels: int = 3
             ) -> ResNet:
    """ WideResNet by Zagoruyko&Komodakis 17
    """
...
def wrn40_2_nosequential(num_classes: int = 10,
            in_channels: int = 3
            ) -> ResNet:
    """ WideResNet by Zagoruyko&Komodakis 17
    """
...
def resnext29_32x4d_nosequential(num_classes: int = 10,
                    in_channels: int = 3
                    ) -> ResNet:
    """ ResNeXT by Xie+17
    """
...
def resnext29_8x64d_nosequential(num_classes: int = 10,
                    in_channels: int = 3
                    ) -> ResNet:
    """ ResNeXT by Xie+17
    """
...
def wrn28_2_attention_pool_nosequential(num_classes: int = 10,
                           in_channels: int = 3,
                           num_heads: int = 2
                           ) -> ResNet:
...
def wrn28_10_attention_pool_nosequential(num_classes: int = 10,
                            in_channels: int = 3,
                            num_heads: int = 10
                            ) -> ResNet:
