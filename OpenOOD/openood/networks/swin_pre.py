...
class swin_1kpre(torch.nn.Module):
    def __init__(self,num_classes=10,weight_path=None):
        super().__init__()
        self.basemodel = timm.create_model("hf_hub:anonauthors/cifar10-timm-swin_base_patch4_window7_224.ms_in22k_ft_in1k", pretrained=True)
